...
class BasicRotationGate(BasicGate):
    ...
    def tex_str(self):
        ...
        .. code-block:: latex
            ...
            [CLASSNAME]$_[ANGLE]$
        """
        return str(self.__class__.__name__) + "$_{" + str(self.angle/math.pi) + "}$"
...
class BasicPhaseGate(BasicGate):
    ...
    def tex_str(self):
        ...
        if self.angle2 < 0:
            return str(self.__class__.__name__) + "$_{" + str(int(math.log(-math.pi / self.angle2, 2))) + "}$" + r"${}^\dagger$"
        else:
            return str(self.__class__.__name__) + "$_{" + str(int(math.log(math.pi/self.angle2, 2))+1) + "}$"
